...
namespace WindowsFormsApplication1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemsRow AddItemsRow(int Id, string Name, byte ListId, byte[] DateAdded) {
        ...
        public partial class ListsDataTable : global::System.Data.TypedTableBase<ListsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ListsRow AddListsRow(int Id, string Name) {
...
namespace WindowsFormsApplication1.DataSet1TableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([Id], [Name], [ListId]) VALUES (@Id, @Name, @ListId);\r" +
                "\nSELECT Id, Name, ListId, DateAdded FROM Items WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [Id] = @Id, [Name] = @Name, [ListId] = @ListId WHERE (([Id] = @Original_Id) AND ((@IsNull_DateAdded = 1 AND [DateAdded] IS NULL) OR ([DateAdded] = @Original_DateAdded)));
SELECT Id, Name, ListId, DateAdded FROM Items WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, ListId, DateAdded FROM dbo.Items";
        ...
        public virtual int Insert(int Id, string Name, global::System.Nullable<byte> ListId) {
            ...
            if ((ListId.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((byte)(ListId.Value));
            }
            else {
        ...
        public virtual int Update(int Id, string Name, global::System.Nullable<byte> ListId, int Original_Id, byte[] Original_DateAdded) {
            ...
            if ((ListId.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((byte)(ListId.Value));
            }
            else {
        ...
        public virtual int Update(string Name, global::System.Nullable<byte> ListId, int Original_Id, byte[] Original_DateAdded) {
            return this.Update(Original_Id, Name, ListId, Original_Id, Original_DateAdded);
        }
    }
    ...
    public partial class ListsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Lists] ([Id], [Name]) VALUES (@Id, @Name);\r\nSELECT Id, Name FR" +
                "OM Lists WHERE (Id = @Id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Lists] SET [Id] = @Id, [Name] = @Name WHERE (([Id] = @Original_Id) " +
                "AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)));\r\nSELE" +
                "CT Id, Name FROM Lists WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
